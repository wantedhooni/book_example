...
SOFTWARE.
*/
package com.apress.prospring7.boot.thirteen.handler;
...
import com.apress.prospring7.boot.thirteen.service.SingerService;
import com.apress.prospring7.boot.thirteen.util.CriteriaDto;
import com.apress.prospring7.boot.thirteen.util.CriteriaValidator;
...
public class SingerHandler {
    ...
    public SingerHandler(SingerService singerService) {
        ...
        findById = serverRequest ->
                singerService.findById(Long.parseLong(serverRequest.pathVariable("id")))
    ...
    public Mono<ServerResponse> create(ServerRequest serverRequest) {
        ...
        return singerMono
                ...
                .log()
                .flatMap(s -> created(URI.create("/singer/" + s.id()))
    ...
    public Mono<ServerResponse> searchSinger(ServerRequest serverRequest) {
        ...
        if ((ObjectUtils.isEmpty(fn) || ObjectUtils.isEmpty(ln))) {
    ...
    public Mono<ServerResponse> search(ServerRequest serverRequest) {
        var criteriaMono = serverRequest.bodyToMono(CriteriaDto.class);
    ...
    private Mono<CriteriaDto> validate(CriteriaDto criteria) {
