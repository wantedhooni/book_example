...
public class SingerServiceImpl implements SingerService {
    ...
    public Flux<Singer> findByCriteriaDto(CriteriaDto criteria) {
        ...
        return  switch (fieldName)  {
            ...
            case BIRTHDATE -> "*".equals(criteria.getFieldValue()) ? singerRepo.findAll()
    ...
    public Mono<Singer> update(Long id, Singer updateData) {
        return singerRepo.findById(id)
                .flatMap(_ -> {
                    var updateObj = new Singer(id, updateData.firstName(), updateData.lastName(), updateData.birthDate());
                    return singerRepo.save(updateObj).onErrorMap(error -> new SaveException("Could Not Update Singer " + updateData, error));
                });
    }
