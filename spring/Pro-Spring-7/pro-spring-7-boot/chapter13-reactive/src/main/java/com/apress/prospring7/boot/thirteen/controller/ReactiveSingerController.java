...
SOFTWARE.
*/
package com.apress.prospring7.boot.thirteen.controller;
...
///
/// @author iulianacosmina on 25/01/2026
///
@RestController
...
public class ReactiveSingerController {
    ...
    public ReactiveSingerController(SingerService singerService) {
    ...
    public Mono<Singer> searchSinger(@RequestParam("fn") String fn, @RequestParam("ln") String ln) {
        if ((!StringUtils.hasLength(fn) || !StringUtils.hasLength(ln))) {
