...
import static com.apress.prospring7.boot.thirteen.repo.SingerRepositoryTest.NICK;
...
@Disabled("It is very hard to stop Spring Boot from autoconfiguring things. " +
        ...
        "It is left here as an example, and hope that someday day I'll have the time to jump through those hoops.")
@Testcontainers
@ActiveProfiles("test")
@DataR2dbcTest
...
public class SingerServiceTest {
    ...
    void testFindByFullName(){
        singerService.findByFirstNameAndLastName("Nick", "Drake").log()
                .as(StepVerifier::create)
                .expectNext(NICK)
                .verifyComplete();
    }
