...
public class LetterSender {
    private static final Logger LOGGER = LoggerFactory.getLogger(LetterSender.class);
    ...
    public LetterSender(KafkaTemplate<String, Object> kafkaTemplate) {
        this.kafkaTemplate = kafkaTemplate;
    }

    // make application configurabile
    public void send(Letter letter) {
        LOGGER.info(">>>> [{}] Sending letter -> {}", sender, letter);
