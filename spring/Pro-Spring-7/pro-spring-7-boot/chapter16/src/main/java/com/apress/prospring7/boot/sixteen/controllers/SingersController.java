...
SOFTWARE.
*/
package com.apress.prospring7.boot.sixteen.controllers;

import com.apress.prospring7.boot.sixteen.entitites.AbstractEntity;
import com.apress.prospring7.boot.sixteen.entitites.Singer;
import com.apress.prospring7.boot.sixteen.ex.InvalidCriteriaException;
import com.apress.prospring7.boot.sixteen.services.SingerService;
import com.apress.prospring7.boot.sixteen.util.CriteriaDto;
import com.apress.prospring7.boot.sixteen.util.SingerForm;
...
import static com.apress.prospring7.boot.sixteen.util.SiteUtil.encodeUrlPathSegment;
import static com.apress.prospring7.boot.sixteen.util.SiteUtil.setPhoto;
...
public class SingersController {
    ...
    public String create(@Valid SingerForm singerForm, BindingResult bindingResult, Model uiModel,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/singer/" + encodeUrlPathSegment(created.getId().toString(),
                    httpServletRequest);
        }
    }
    ...
    public String processSubmit(@Valid @ModelAttribute("criteriaDto") CriteriaDto criteria,
        ...
        try {
            ...
            if (singers.isEmpty()) {
                ...
                return "redirect:/singer/" + singers.getFirst().getId();
            } else {
