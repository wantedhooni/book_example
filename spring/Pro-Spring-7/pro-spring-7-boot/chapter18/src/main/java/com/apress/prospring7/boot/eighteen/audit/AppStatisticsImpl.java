...
SOFTWARE.
*/
package com.apress.prospring7.boot.eighteen.audit;

import com.apress.prospring7.boot.eighteen.entities.Singer;
import com.apress.prospring7.boot.eighteen.services.SingerService;
...
///
/// @author iulianacosmina on 18/02/2026
///
@Component
@ManagedResource(description = "JMX managed resource", objectName = "jmxBootDemo:name=ProSpring7SingerApp")
public class AppStatisticsImpl implements AppStatistics{
    ...
    public String findJohn() {
        ...
        if (!singers.isEmpty()) {
            return singers.getFirst().getFirstName() + " " + singers.getFirst().getLastName() + " " + singers.getFirst().getBirthDate();
        }
        return "not found";
    }
