...
import com.apress.prospring7.boot.thirteen.entities.AbstractEntity;
import com.apress.prospring7.boot.thirteen.entities.Singer;
import com.apress.prospring7.boot.thirteen.ex.InvalidCriteriaException;
...
import com.apress.prospring7.boot.thirteen.util.SingerForm;
import com.apress.prospring7.boot.thirteen.util.SiteUtil;
...
public class SingersController {
    ...
    public String create(@Valid SingerForm singerForm, BindingResult bindingResult, Model uiModel,
        ...
        return "redirect:/singer/" + SiteUtil.encodeUrlPathSegment(created.getId().toString(),
                httpServletRequest);
    }
