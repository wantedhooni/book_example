...
import com.apress.prospring7.boot.thirteen.ex.NotFoundException;
...
import static com.apress.prospring7.boot.thirteen.util.SiteUtil.setPhoto;
...
public class OneSingerController {
    ...
    @GetMapping
    public String showSingerData(@PathVariable Long id, Model uiModel) {
        final var singer = singerService.findById(id);
    ...
    public String showPhotoUploadForm(@PathVariable Long id, Model uiModel) {
        Singer singer = singerService.findById(id);
    ...
    public String handleFileUpload(@RequestParam(value ="file", required=false) MultipartFile file, @PathVariable Long id) throws NotFoundException, IOException {
    ...
    @DeleteMapping
    public String deleteSinger(@PathVariable Long id) throws NotFoundException {
