...
import com.apress.prospring7.boot.seven.view.SingerSummary;
import com.apress.prospring7.boot.seven.view.SingerSummaryRecord;
...
public interface SingerSummaryService {
    ...
    String ALL_SINGER_SUMMARY_JPQL_QUERY ="""
            select new com.apress.prospring7.boot.seven.view.SingerSummary(
