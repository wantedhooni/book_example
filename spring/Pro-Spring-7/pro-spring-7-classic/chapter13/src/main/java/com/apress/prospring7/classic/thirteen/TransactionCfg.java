...
@Configuration
@EnableJpaRepositories(basePackages = {"com.apress.prospring7.classic.thirteen.repos"})
@EnableTransactionManagement
@ComponentScan(basePackages = {"com.apress.prospring7.classic.thirteen.services"})
public class TransactionCfg {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.apress.prospring7.classic.thirteen.entities");
