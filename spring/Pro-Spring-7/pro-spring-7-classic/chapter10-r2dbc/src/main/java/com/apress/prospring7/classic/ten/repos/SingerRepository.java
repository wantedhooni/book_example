...
SOFTWARE.
*/
package com.apress.prospring7.classic.ten.repos;
...
public interface SingerRepository extends R2dbcRepository<Singer, Long> {

    @Query("select * from singer where first_name=:fn and last_name=:ln")
    Mono<Singer> findByFullName(@Param("fn") String firstName, @Param("ln") String lastName);
