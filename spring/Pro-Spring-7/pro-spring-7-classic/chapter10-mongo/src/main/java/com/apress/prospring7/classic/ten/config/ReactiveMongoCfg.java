...
@EnableReactiveMongoRepositories(basePackages = "com.apress.prospring7.classic.ten.repos")
public class ReactiveMongoCfg extends AbstractReactiveMongoConfiguration {
