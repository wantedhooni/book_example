...
SOFTWARE.
*/
package com.apress.prospring7.classic.thirteen.ex;
...
public class GlobalExceptionHandler {
   ...
   /* @ExceptionHandler(ServerWebInputException.class)
    ...
    public ModelAndView badRequest(HttpServletRequest req, ServerWebInputException ex) {
        final var mav = new ModelAndView();
        mav.addObject("problem", "Bad Request: " + req.getRequestURI() +  ex.getReason());
        mav.setViewName("error");
        return mav;
    }*/
}
