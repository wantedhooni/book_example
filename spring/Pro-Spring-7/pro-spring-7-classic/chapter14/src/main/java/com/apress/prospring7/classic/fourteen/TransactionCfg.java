...
@Configuration
@EnableJpaRepositories(basePackages = {"com.apress.prospring7.classic.fourteen.repos"})
@EnableTransactionManagement
@ComponentScan(basePackages = {"com.apress.prospring7.classic.fourteen.repos"})
public class TransactionCfg {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.apress.prospring7.classic.fourteen.entities");
