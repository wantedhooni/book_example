...
public class SingerController {
    final static Logger LOGGER = LoggerFactory.getLogger(SingerController.class);
    ...
    public void update(@RequestBody /*@Valid */Singer singer, @PathVariable Long id) { // if we enable validation we cannot provide a Singer with missing fields
        ...
        singerRepo.save(new Singer(id, singer.getFirstName(), singer.getLastName(), singer.getBirthDate()));
