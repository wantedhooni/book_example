...
public class RestClientTest {
 ...
 private static final String URI_SINGER_ROOT = "http://localhost:8080/ch14/singer/";
 private static final String URI_SINGER_WITH_ID = "http://localhost:8080/ch14/singer/{id}";
 ...
 public void testFindAllWithExecute() {
  ...
  var singers = restTemplate.execute(URI_SINGER_ROOT, HttpMethod.GET,
          _ -> LOGGER.debug("Request submitted ..."),
          response -> {
