...
///
@Configuration
@ComponentScan(basePackages  = {"com.apress.prospring7.eleven"},
        excludeFilters = @ComponentScan.Filter(  // needed to avoid configuration pollution
                type = FilterType.ASSIGNABLE_TYPE,
                classes = {TaskSchedulingConfig1.class, TaskSchedulingConfig2.class, TaskSchedulingConfig3.class})
)
@EnableScheduling
...
class RejectedTaskHandler implements RejectedExecutionHandler {
    ...
    private final Map<Runnable, Integer> rejectedTasks = new ConcurrentHashMap<>();
