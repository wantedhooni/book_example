...
@EnableJpaRepositories(basePackages = {"com.apress.prospring7.eleven.advanced.repo"})
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.apress.prospring7.eleven.advanced.entitites");
