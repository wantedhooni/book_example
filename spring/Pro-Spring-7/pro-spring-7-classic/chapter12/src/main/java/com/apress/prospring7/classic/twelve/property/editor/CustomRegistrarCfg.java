...
SOFTWARE.
*/
package com.apress.prospring7.classic.twelve.property.editor;
...
public class CustomRegistrarCfg {
    ...
    public CustomEditorConfigurer customEditorConfigurer() {
        final var cus = new CustomEditorConfigurer();
        final var registrars = new PropertyEditorRegistrar[1];
