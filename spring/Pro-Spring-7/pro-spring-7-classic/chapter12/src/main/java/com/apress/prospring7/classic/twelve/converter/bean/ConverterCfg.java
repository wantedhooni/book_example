...
SOFTWARE.
*/
package com.apress.prospring7.classic.twelve.converter.bean;
...
public class ConverterCfg {
    ...
    public ConversionServiceFactoryBean conversionService() {
        final var conversionServiceFactoryBean = new ConversionServiceFactoryBean();
        final var convs = new HashSet<>();
