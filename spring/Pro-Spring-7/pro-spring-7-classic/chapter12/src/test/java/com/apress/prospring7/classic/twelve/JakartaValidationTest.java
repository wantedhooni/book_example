...
import com.apress.prospring7.classic.twelve.domain.Singer;
import com.apress.prospring7.classic.twelve.domain.SingerTwo;
import com.apress.prospring7.classic.twelve.validator.JakartaValidationCfg;
import com.apress.prospring7.classic.twelve.validator.SingerTwoValidationService;
import com.apress.prospring7.classic.twelve.validator.SingerValidationService;
...
public class JakartaValidationTest {
    ...
    void testSingerValidation() {
        try (final var ctx = new AnnotationConfigApplicationContext(JakartaValidationCfg.class)) {
